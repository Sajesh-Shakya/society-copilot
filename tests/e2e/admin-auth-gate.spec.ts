...
// The main happy path for admin-gated pages, without needing a real
// magic-link session: an unauthenticated visitor is bounced to /login
// rather than seeing the page or a raw error. This exercises
